...
- **Tenure** (how long they stay) is the biggest indicator of loyalty.
- Adding services like **Online Security** helps keep customers longer.

## 🛠 Tools Used
- **Python** (Pandas, Scikit-Learn)
- **Machine Learning**: Random Forest (Our best model!)
